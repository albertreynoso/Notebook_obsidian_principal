...
## Herramientas
### Litmaps
Estrategias para una Revisión de Literatura Eficiente y de Calidad
https://www.litmaps.com/

| Concepto                        | Información Relevante                                                                                                                                                                                                                 |
| ------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Enfoque Crítico**             | Se advierte contra métodos engañosos como copiar y pegar resúmenes. Para una revisión de calidad, es esencial leer los artículos en detalle. La clave es automatizar las partes correctas del proceso.                                |
| **Búsqueda Eficiente**          | Usar la herramienta **Lit Maps**. Se comienza buscando un artículo relevante y luego se explora la red de artículos conectados a este ("Explore related articles").                                                                   |
| **Refinamiento de la Búsqueda** | Para enfocarse en subtemas, se utilizan **filtros** en Lit Maps: fecha de publicación, palabras clave específicas, autores, revistas y cuartiles de impacto (ej. Q1). Esto reduce el "ruido" y prioriza los artículos más relevantes. |
| **Organización**                | Usar **etiquetas (tags)** en Lit Maps para categorizar los artículos (por teoría, metodología, subtema, etc.). Esto ayuda a visualizar las conexiones entre temas y ahorra horas al momento de escribir y citar.                      |
| **Exportación y Cita**          | Se puede **exportar** la lista de artículos y **incluir una imagen del mapa** de literatura en la publicación final. Lit Maps proporciona directrices para ser citado correctamente en trabajos académicos.                           |
Relacionados:
https://www.youtube.com/watch?v=gxm3ahIaO7c - How to do a literature review: 5 minute guide with Litmaps
### Semantic Scholar
### Research Rabbit
### Zotero
### Mendeley
...
A continuación, se presenta la deconstrucción completa del contenido en formato de hoja de referencia.
...
|                                       | **Plantilla de Diapositiva**    | Campos Específicos: Título, Link, Mensajes Clave, Figuras, Tags       | La plantilla estandarizada fuerza la consistencia. Incluye: **Título del paper**, **Enlace** al documento, **Mensajes para llevar** (3 puntos), **Figuras interesantes** (capturas) y **Tags** predefinidos.                                               |
